...
<head>
  ...
  <title>Safari Run</title>
    ...
    <!-- Theme CSS -->
    <link href="/assets/css/now-design-system-pro.min.css" type="text/css" rel="stylesheet">
    ...
    <!-- Theme JS -->
    <script src="/assets/js/now-design-system-pro.min.js" type="text/javascript"></script>
